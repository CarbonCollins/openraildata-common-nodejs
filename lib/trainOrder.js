...
class TrainOrder {
   ...
   * @readonly
   */
  get crs() { return (this._payload) ? this._payload.crs : null; }
  /**
   * @desc gets the platform identifier
   * @returns {String|null}
   * @readonly
   */
  get platform() { return (this._payload && this._payload.platform) ? this._payload.platform : null; }
  /**
   ...
   * @readonly
   */
  get sets() { return (this._payload && this._payload.set) ? this._payload.set : null; }
  
  get first() { return (this._payload && this._payload.set && this._payload.set.first) ? this._payload.set.first : null; }
  get second() { return (this._payload && this._payload.set && this._payload.set.second) ? this._payload.set.second : null; }
  get third() { return (this._payload && this._payload.set && this._payload.set.third) ? this._payload.set.third : null; }
   ...
   * @readonly
   */
  get clears() { return (this._payload && this._payload.clear) ? this._payload.clear : null; }
   ...
   * @returns {Boolean}
   */
  isSet() { return this._payload && this._payload.set; }
   ...
   * @returns {Boolean}
   */
  isClear() { return this._payload && this._payload.clear; }
}
