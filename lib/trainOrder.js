...
class TrainOrder {
   ...
   */
  get first() {
    return (this._payload.set && this._payload.set.first)
      ? this._payload.set.first
      : null;
  }
   ...
   */
  get second() {
    return (this._payload.set && this._payload.set.second)
      ? this._payload.set.second
      : null;
  }
   ...
   */
  get third() {
    return (this._payload.set && this._payload.set.third)
      ? this._payload.set.third
      : null;
  }
