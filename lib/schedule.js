...
class Schedule {
   ...
   */
  get origin() {
    return (this._payload.OR || this._payload.OPOR)
      ? new Station(this._payload.OR || this._payload.OPOR)
      : null;
  }
   ...
   */
  get destination() {
    return (this._payload.DT || this._payload.OPDT)
      ? new Station(this._payload.DT || this._payload.OPDT)
      : null;
  }
